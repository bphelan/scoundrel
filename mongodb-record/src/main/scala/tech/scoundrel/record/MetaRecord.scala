...
import net.liftweb.http.{ LiftResponse, LiftRules, Req }
import net.liftweb.http.js.JE.JsObj
import net.liftweb.http.js.{ JsExp, JsObj }
import net.liftweb.json._
import net.liftweb.util._
import FieldHelpers.expectedA
...
trait MetaRecord[BaseRecord <: Record[BaseRecord]] {
  ...
  this.runSafe {
    ...
    lifecycleCallbacks = (for (
      v <- methods if v.getName != "meta" && isLifecycle(v)
   ...
   *
   * @param original - original the initial record
   * @param field - field the new mutated field
   ...
   * @param inst -- the instance to get the field on
   *
